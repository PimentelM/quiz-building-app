...
export class AuthService {
	...
	constructor(private userRepository: UserRepository,
				@Inject("authMailSenderService") private authMailSenderService: IAuthMailSender) {
	}
	...
	async sendUserActivationEmail(email: string) {
		...
		await this.authMailSenderService.sendActivationMail(email, token);
	}
	...
	async sendResetPasswordEmail(email: string) {
		...
		await this.authMailSenderService.sendPasswordResetMail(email, token);
	}
